...
import getLists from "../actions/list/getLists";
...
class EasyTabsContainer extends React.Component<IEasyTabsContainerProps, {}> {
  ...
  public fetchDetails() {
    console.log(
      ...
      "siteContext in component didmount EasyTabsContainer"
    );
    console.log(
      "%c MyApp:",
      "background:blue;color:white",
    ...
    if (isEmpty(this.props.siteContext)) {
      ...
      console.log(
        ...
        "Site Context Empty, hence fetching data"
      );
    ...
    if (this.props.listDetails) {
      console.log(
        "%c MyApp:",
        "background:green;color:white",
        "Found list Details, now returning"
      );
